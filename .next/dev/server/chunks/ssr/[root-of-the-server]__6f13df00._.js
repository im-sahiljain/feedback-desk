...
const mockProducts = [
    {
        ...
        industry: 'tech',
        config: {
            categories: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_CATEGORIES"].tech,
            aiPrompt: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_AI_PROMPTS"].tech,
            focusAreas: [
    ...
    },
    {
        ...
        industry: 'healthcare',
        config: {
            categories: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_CATEGORIES"].healthcare,
            aiPrompt: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_AI_PROMPTS"].healthcare,
            focusAreas: [
                'Patient safety',
                'Wait time reduction',
                'Staff training'
    ...
    },
    {
        ...
        config: {
            categories: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_CATEGORIES"].infrastructure,
            aiPrompt: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_AI_PROMPTS"].infrastructure,
            focusAreas: [
                'Safety compliance',
                'Timeline adherence',
                'Quality standards'
...
async function analyzeTextWithMockAI(text, industry, customCategories) {
    ...
    const categories = customCategories || __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_CATEGORIES"][industry];
...
function AppProvider({ children }) {
    ...
    const addProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((productData)=>{
        const newProduct = {
            ...productData,
            id: `prod-${Date.now()}`,
            createdAt: new Date()
    ...
    const updateProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((id, updates)=>{
        ...
        setCurrentProduct((prev)=>prev?.id === id ? {
                ...prev,
                ...updates
            } : prev);
    }, []);
    ...
    const getProductFeedback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((productId)=>feedback.filter((f)=>f.productId === productId), [
        feedback
    ]);
    const addFeedback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (feedbackData)=>{
        const newFeedback = {
            ...feedbackData,
            id: `fb-${Date.now()}`,
            createdAt: new Date(),
        ...
        if (product) {
            try {
                const analysis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["analyzeTextWithMockAI"])(feedbackData.text, product.industry, product.config.categories);
                setFeedback((prev)=>prev.map((f)=>f.id === newFeedback.id ? {
                            ...f,
                            analysis,
                            isAnalyzing: false
                        } : f));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f13df00._.js.map